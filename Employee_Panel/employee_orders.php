...
<head>
   ...
   <title>Luna Coffee - Admin Panel - Orders</title>
...
<?php include 'employee_header.php'; ?>
    ...
    <center><h1  style=" align-content: center; text-align: center; text-shadow:1px 1px 3px black; color: brown; background-color: cornsilk; border: 3px solid chocolate; width:50%"> NEW ORDERS</h1></center>
            ...
            <tr class="Product-info" style="border: 3px solid chocolate">
                <table align="center" style="text-align: center; border: 3px solid chocolate; width:50%" class="Products">
                    ...
                    <th>Your Items: </th>
                        ...
                        <div class="clearfix">
                        <td colspan="2"style="border:2px solid black"><strong style="font-family:copperplate; font-size: 25px">TOTAL: $<?php echo($total); ?></strong></td>
                        <td><a href="order_completed.php" class="btnAdd" style="font-size: 16px; text-decoration: none; background-color: green">Order Completed</a></td>
                        <td><a href="order_declined.php" class="btnAdd" style="font-size: 16px; text-decoration: none; background-color: black">Cancel Order</a></td>
                        </div>
                        </tr>
